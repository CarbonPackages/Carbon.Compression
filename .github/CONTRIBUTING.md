...
* Create an [issue](https://github.com/jonnitto/Carbon.Compression/issues) on GitHub, if you have found a bug
...
* Submit an [issue](https://github.com/jonnitto/Carbon.Compression/issues), assuming one does not already exist.
